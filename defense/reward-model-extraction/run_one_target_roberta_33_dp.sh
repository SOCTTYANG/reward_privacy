...
MODEL_PATH="$1"
RUN_NAME="$2"
CORE_DIR="${PROJECT_DIR}/reward-model-extraction"
DEFENSE_DIR="${PROJECT_DIR}/defense/reward-model-extraction"
cd "${CORE_DIR}"
...
python "${DEFENSE_DIR}/train_target_rm_llama_lora_dp.py" \
