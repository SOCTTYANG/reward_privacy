...
bash "${RUN_ONE}" /mnt/model_data/models/llama2-13b-hf llama2_13b
bash "${RUN_ONE}" /mnt/model_data/models/llama32-3b llama32_3b
bash "${RUN_ONE}" /mnt/model_data/models/mistral-7b-v0.1 mistral_7b
bash "${RUN_ONE}" /mnt/model_data/models/qwen3-8b qwen3_8b
